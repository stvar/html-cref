...
#include "html-cref.h"
#include "html-cref-iwtrie.h"

size_t html_cref_iwtrie_get_version(void)
{ return HTML_CREF_VERSION; }

// $ html-cref-gen --gen-func --heading --wide-code --indexed-access -- -f html_cref_iwtrie_parse > html-cref-iwtrie-impl.h

#include "html-cref-iwtrie-impl.h"

API_ALIAS(iwtrie, parse, lookup)

#ifdef TIMINGS
HTML_CREF_FUNC_DEF(iwtrie, lookup)
HTML_CREF_FUNC_DEF(iwtrie, parse)
#endif
