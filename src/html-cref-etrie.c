...
#include "html-cref.h"
#include "html-cref-etrie.h"

size_t html_cref_etrie_get_version(void)
{ return HTML_CREF_VERSION; }

// $ html-cref-gen --gen-func --expanded-path -- -f html_cref_etrie_parse > html-cref-etrie-impl.h

#include "html-cref-etrie-impl.h"

API_ALIAS(etrie, parse, lookup)

#ifdef TIMINGS
HTML_CREF_FUNC_DEF(etrie, lookup)
HTML_CREF_FUNC_DEF(etrie, parse)
#endif
