...
// $ re2c html-cref-re2c-impl.def > html-cref-re2c-impl.h

static int html_cref_re2c_parse0(
    const char* p)
{
    const char *q;
...
#define YYCURSOR p
#define YYMARKER q
#include "html-cref-re2c-impl.h"
}

API_ALIAS(re2c, parse0, lookup)
API_ALIAS(re2c, parse0, parse)

#ifdef TIMINGS
HTML_CREF_FUNC_DEF(re2c, lookup)
HTML_CREF_FUNC_DEF(re2c, parse)
#endif
